(function () {
	...
	var model = function(authContext, skipFilter) {
		return Database.Model.extend({
			...
			constructor: function() {
				...
				this.on("fetching", Auid.Fetching(authContext, filter, ['id', 'pageid', 'blockid', 'blockcontainerareaid', 'blockcontainerid', 'blocksettingdefid', 'client.id', 'site.id'], skipFilter));
	...
	var collection = function(authContext, skipFilter) {
		...
		.on("fetching", Auid.Fetching(authContext, filter, ['id', 'blockid', 'blockcontainerareaid', 'blockcontainerid', 'blocksettingdefid', 'pageid', 'client.id', 'site.id'], skipFilter))
