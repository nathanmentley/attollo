...
(function () {
	...
	classDef.prototype.Logic = function(dbContext, callback, errorCallback) {
        Promise.all([
            ...
            attollo.Services.Block.AddBlockTemplateDef(dbContext, BlockDefCodes.Image, 'ImageHtml1', 'Html 2', '<p><img src={"/Assets?filename=" + this.state.Settings["imageUrl"]} alt={this.state.Settings["imageCaption"]} /></p>'),
